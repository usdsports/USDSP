Contributing to USDSports
============================

The USDSports project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/usdsports-project/usdsports/blob/master/doc/translation_process.md)
...
The following applies to code changes to the USDSports project, and is not to be
confused with overall USDSports Network Protocol consensus changes.

Whether a pull request is merged into USDSports rests with the project merge
...
Patches that change USDSports consensus rules are considerably more involved than
...
Where a patchset proposes to change the USDSports consensus, it must have been
...
The project leader is the release manager for each USDSports release.
