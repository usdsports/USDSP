...
The script [extract-osx-sdk.sh](https://github.com/usdsports-project/usdsports/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
usdsports/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/usdsports-project/usdsports/blob/master/doc/README_osx.md) for troubleshooting tips.
