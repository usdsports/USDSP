...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop USDSports server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "USDSports server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* USDSports features */
        {"usdsports", "listmasternodes", &listmasternodes, true },
        {"usdsports", "getmasternodecount", &getmasternodecount, true },
        {"usdsports", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"usdsports", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"usdsports", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"usdsports", "masternodecurrent", &masternodecurrent, true },
        {"usdsports", "startmasternode", &startmasternode, true },
        {"usdsports", "createmasternodekey", &createmasternodekey, true },
        {"usdsports", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"usdsports", "listmasternodeconf", &listmasternodeconf, true },
        {"usdsports", "getmasternodestatus", &getmasternodestatus, true },
        {"usdsports", "getmasternodewinners", &getmasternodewinners, true },
        {"usdsports", "getmasternodescores", &getmasternodescores, true },
        {"usdsports", "preparebudget", &preparebudget, true },
        {"usdsports", "submitbudget", &submitbudget, true },
        {"usdsports", "mnbudgetvote", &mnbudgetvote, true },
        {"usdsports", "getbudgetvotes", &getbudgetvotes, true },
        {"usdsports", "getnextsuperblock", &getnextsuperblock, true },
        {"usdsports", "getbudgetprojection", &getbudgetprojection, true },
        {"usdsports", "getbudgetinfo", &getbudgetinfo, true },
        {"usdsports", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"usdsports", "mnfinalbudget", &mnfinalbudget, true },
        {"usdsports", "checkbudgets", &checkbudgets, true },
        {"usdsports", "mnsync", &mnsync, true },
        {"usdsports", "spork", &spork, true },
...
{
    return "> usdsports-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2620/\n";
}
