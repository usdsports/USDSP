...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("USDSports usdsports-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  usdsports-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded usdsports transaction") + "\n" +
                               "  usdsports-tx [options] -create [commands]   " + _("Create hex-encoded usdsports transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded usdsports transaction
