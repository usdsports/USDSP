...
/* USDSports GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "USDSports"
#define QAPP_ORG_DOMAIN "usdsports.org"
#define QAPP_APP_NAME_DEFAULT "USDSports-Qt"
#define QAPP_APP_NAME_TESTNET "USDSports-Qt-testnet"
