...
/** Utility functions used by the USDSports Qt UI.
 */
namespace GUIUtil
{
...
// Render USDSports addresses in monospace font
...
// Parse "usdsports:" URI into recipient object, return true on successful parsing
