...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            USDSportsGUI* window = static_cast<USDSportsGUI*>(parentWidget());
...
{
    USDSportsGUI* gui = static_cast<USDSportsGUI*>(parentWidget());
...
{
    hide();
    static_cast<USDSportsGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("USDSports will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your USDSPs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
