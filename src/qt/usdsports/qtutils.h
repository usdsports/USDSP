...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, USDSportsGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, USDSportsGUI* gui, double posX = 3);
