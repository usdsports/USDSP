...
#include "qt/usdsports/forms/ui_send.h"
#include "qt/usdsports/addnewcontactdialog.h"
#include "qt/usdsports/qtutils.h"
#include "qt/usdsports/sendchangeaddressdialog.h"
#include "qt/usdsports/optionbutton.h"
#include "qt/usdsports/sendconfirmdialog.h"
#include "qt/usdsports/myaddressrow.h"
#include "qt/usdsports/guitransactionsutils.h"
...
SendWidget::SendWidget(USDSportsGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-usdsp");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination usdspAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(usdspAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(usdspAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
