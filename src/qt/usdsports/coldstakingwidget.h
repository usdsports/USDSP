...
#include "qt/usdsports/furabstractlistitemdelegate.h"
#include "qt/usdsports/txviewholder.h"
#include "qt/usdsports/tooltipmenu.h"
#include "qt/usdsports/sendmultirow.h"
#include "qt/usdsports/coldstakingmodel.h"
#include "qt/usdsports/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(USDSportsGUI* parent);
    ~ColdStakingWidget();
