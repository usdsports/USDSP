...
#include "qt/usdsports/sendcustomfeedialog.h"
#include "qt/usdsports/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(USDSportsGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &USDSportsGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
