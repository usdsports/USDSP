...
#include "qt/usdsports/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/usdsports/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(USDSportsGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableUSDSP,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableUSDSP,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableUSDSP,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableUSDSP,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableUSDSP, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableUSDSP);});
    ...
    if (parent)
        connect(parent, &USDSportsGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
