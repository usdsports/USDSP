...
#include "qt/usdsports/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/usdsports/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(USDSportsGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to USDSportsGUI::handleRestart()
