...
#include "qt/usdsports/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(USDSportsGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("USDSports_tx_csv_export(*.csv)") : tr("USDSports_addresses_csv_export(*.csv)"),
                                        nullptr);
