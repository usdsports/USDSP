...
#include "qt/usdsports/settings/settingsnetworkwidget.h"
#include "qt/usdsports/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/usdsports/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(USDSportsGUI* _window, QWidget *parent) :
