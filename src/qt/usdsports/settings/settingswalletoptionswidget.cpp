...
#include "qt/usdsports/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/usdsports/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(USDSportsGUI* _window, QWidget *parent) :
