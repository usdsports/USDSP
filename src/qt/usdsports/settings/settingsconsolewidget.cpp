...
#include "qt/usdsports/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/usdsports/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(USDSportsGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the USD Sports RPC console.") + "<br>" +
