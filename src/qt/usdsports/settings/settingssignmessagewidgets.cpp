...
#include "qt/usdsports/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(USDSportsGUI* _window, QWidget *parent) :
