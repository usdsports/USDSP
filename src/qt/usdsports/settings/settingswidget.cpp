...
#include "qt/usdsports/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(USDSportsGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &USDSportsGUI::openFAQ);
