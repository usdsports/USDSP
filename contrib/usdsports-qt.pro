...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/usdsports-cli.cpp \
           src/usdsports-tx.cpp \
           src/usdsports.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/usdsports.qrc src/qt/usdsports_locale.qrc

TRANSLATIONS += src/qt/locale/usdsports_bg.ts \
                src/qt/locale/usdsports_de.ts \
                src/qt/locale/usdsports_en.ts \
                src/qt/locale/usdsports_es.ts \
                src/qt/locale/usdsports_fi.ts \
                src/qt/locale/usdsports_fr.ts \
                src/qt/locale/usdsports_it.ts \
                src/qt/locale/usdsports_ja.ts \
                src/qt/locale/usdsports_pl.ts \
                src/qt/locale/usdsports_pt.ts \
                src/qt/locale/usdsports_ru.ts \
                src/qt/locale/usdsports_sk.ts \
                src/qt/locale/usdsports_sv.ts \
                src/qt/locale/usdsports_vi.ts \
                src/qt/locale/usdsports_zh_CN.ts \
                src/qt/locale/usdsports_zh_TW.ts
