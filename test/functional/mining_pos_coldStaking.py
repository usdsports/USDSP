...
from test_framework.usdsports_node import USDSportsTestNode
...
class USDSports_ColdStakingTest(USDSportsTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(USDSportsTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 USDSP from the pot)
...
if __name__ == '__main__':
    USDSports_ColdStakingTest().main()
